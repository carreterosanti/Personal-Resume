    ...
    <div className="middle-section">
      ...
      <div className="work-experience-div">
        <div style={{ flexGrow: 2 }}>
          ...
          <p>
            A pesar de que es una experiencia laboral en el ámbito gastronómico
            y no en el desarrollo de software, puedo destacar que formar parte
            de un equipo de trabajo en una empresa donde los estándares de
